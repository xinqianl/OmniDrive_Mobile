              ...
              radius:(CGFloat) radius
{
    ...
    if (self)
    {
        ...
        self.backgroundColor = [UIColor colorWithRed:(123/255.0) green:(177/255.0) blue:(205/255.0) alpha:1];
  ...
  ePieChartDataModel:(EPieChartDataModel *)ePieChartDataModel
{
    ...
    if (self)
    {
        ...
        _currentColor = [UIColor colorWithRed:(12/255.0) green:(90/255.0) blue:(172/255.0) alpha:1];
        ...
        self.title.font = [UIFont fontWithName:@"Menlo-Bold" size:25];
