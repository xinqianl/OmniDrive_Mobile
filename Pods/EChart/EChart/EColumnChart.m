    ...
    if (_dataSource != dataSource)
    {
        ...
        
        {
            ...
            for (int i = 0; i < 11; i++)
            {
                ...
                eColumnChartLabel.textColor=[UIColor whiteColor];
                ...
                [eColumnChartLabel setFont:[UIFont systemFontOfSize:36]];
...
- (void)initData
{
    ...
    _minColumnColor = [UIColor colorWithRed:(253/255.0) green:(223/255.0) blue:(51/255.0) alpha:1];
    _maxColumnColor = [UIColor colorWithRed:(253/255.0) green:(223/255.0) blue:(51/255.0) alpha:1];
    _barColor = [UIColor colorWithRed:(253/255.0) green:(223/255.0) blue:(51/255.0) alpha:1];
...
- (void)reloadData
{
    ...
    for (int i = 0; i < totalColumnsRequired; i++)
    {
        ...
        if (nil == eColumn)
        {
            ...
            eColumn.barColor = [UIColor lightGrayColor];
        ...
        eColumn.barColor = self.barColor;
